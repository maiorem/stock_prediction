...
samsung_x=samsung_x.astype('float32').reshape(samsung_x.shape[0], samsung_x.shape[1], samsung_x.shape[2], 1)
samsung_y=samsung_y.astype('float32')
samsung_x_predict=samsung_x_predict.astype('float32')
bit_x=bit_x.astype('float32').reshape(bit_x.shape[0], bit_x.shape[1], bit_x.shape[2], 1)
bit_x_predict=bit_x_predict.astype('float32')
gold_x=gold_x.astype('float32').reshape(gold_x.shape[0], gold_x.shape[1], gold_x.shape[2], 1)
gold_x_predict=gold_x_predict.astype('float32')
kosdak_x=kosdak_x.reshape(kosdak_x.shape[0], kosdak_x.shape[1], kosdak_x.shape[2],1)


np.save('./data/monday/conv_samsung_x.npy', arr=samsung_x)
np.save('./data/monday/conv_samsung_x_predict.npy', arr=samsung_x_predict)
np.save('./data/monday/conv_samsung_y.npy', arr=samsung_y)
np.save('./data/monday/conv_bit_x.npy', arr=bit_x)
np.save('./data/monday/conv_bit_x_predict.npy', arr=bit_x_predict)
np.save('./data/monday/conv_gold_x.npy', arr=gold_x)
np.save('./data/monday/conv_gold_x_predict.npy', arr=gold_x_predict)
np.save('./data/monday/conv_kosdak_x.npy', arr=kosdak_x)
np.save('./data/monday/conv_kosdak_x_predict.npy', arr=kosdak_x_predict)
...
samsung_x_predict=samsung_x_predict.reshape(1,5,4,1)
bit_x_predict=bit_x_predict.reshape(1,5,5,1)
gold_x_predict=gold_x_predict.reshape(1,5,6,1)
kosdak_x_predict=kosdak_x_predict.reshape(1,5,3,1)



######### 2. Conv1d 회귀모델
samsung_input1=Input(shape=(5,4))
samsung_layer1=Conv1D(256, kernel_size=2 , padding='same' ,activation='relu')(samsung_input1)
samsunt_layer1=Dropout(0.2)(samsung_layer1)
samsung_layer2=Conv1D(1024, kernel_size=2, padding='same' , activation='relu')(samsung_layer1)
samsung_layer3=Dropout(0.2)(samsung_layer2)
samsung_layer3=Conv1D(512, kernel_size=2, padding='same' , activation='relu')(samsung_layer3)
samsung_layer3=Dropout(0.2)(samsung_layer3)
samsung_layer3=Conv1D(128, kernel_size=2, padding='same' , activation='relu')(samsung_layer3)
samsung_layer3=Flatten()(samsung_layer3)
samsung_layer3=Dense(32, activation='relu')(samsung_layer3)
samsung_layer3=Dense(8, activation='relu')(samsung_layer3)
samsung_output=Dense(1)(samsung_layer3)



bit_input1=Input(shape=(5,5))
bit_layer1=Conv1D(30, kernel_size=2, padding='same' ,activation='relu')(bit_input1)
bit_layer4=Conv1D(500, kernel_size=2, padding='same' ,activation='relu')(bit_layer1)
bit_layer5=Conv1D(200, kernel_size=2, padding='same' ,activation='relu')(bit_layer4)
bit_layer6=Conv1D(100, kernel_size=2, padding='same' ,activation='relu')(bit_layer5)
bit_layer6=Flatten()(bit_layer6)
bit_layer7=Dense(50,activation='relu')(bit_layer6)
bit_output=Dense(1)(bit_layer7)

gold_input1=Input(shape=(5,6))
gold_layer1=Conv1D(20, kernel_size=2, padding='same' ,activation='relu')(gold_input1)
gold_layer4=Conv1D(700,kernel_size=2, padding='same' ,activation='relu')(gold_layer1)
gold_layer5=Conv1D(200,kernel_size=2, padding='same' ,activation='relu')(gold_layer4)
gold_layer6=Conv1D(100,kernel_size=1 , padding='same')(gold_layer5)
gold_layer6=Flatten()(gold_layer6)
gold_layer7=Dense(50,activation='relu')(gold_layer6)
gold_output=Dense(1)(gold_layer7)


kosdak_input1=Input(shape=(5,3))
kosdak_layer1=Conv1D(40, kernel_size=1 , padding='same' ,activation='relu')(kosdak_input1)
kosdak_layer2=Conv1D(900, kernel_size=1 , padding='same' ,activation='relu')(kosdak_layer1)
kosdak_layer4=Conv1D(200, kernel_size=1 , padding='same' ,activation='relu')(kosdak_layer2)
kosdak_layer5=Conv1D(20, kernel_size=1 , padding='same' ,activation='relu')(kosdak_layer4)
kosdak_layer5=Flatten()(kosdak_layer5)
...
modelpath='./model/samsung-conv1d-monday-{epoch:02d}-{val_loss:.4f}.hdf5'
